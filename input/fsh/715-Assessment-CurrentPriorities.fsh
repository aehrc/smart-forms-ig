...
Instance: 715AssessmentCurrentPriorities
...
* url = "http://www.health.gov.au/assessments/mbs/715/715AssessmentCurrentPriorities"
* name = "715AssessmentCurrentPriorities"
* title = "715 Assessment Current Priorities"
* status = #draft
* experimental = true
* subjectType[+] = #Patient
