...
Instance: MedicalHistoryExtractTest
InstanceOf: Questionnaire
Usage: #definition
Title: "Aboriginal and Torres Strait Islander Health Check - MedicalHistoryExtractTest"
Description: "MedicalHistoryExtractTest sub-questionnaire for Aboriginal and Torres Strait Islander Health Check."
...
// Extract hidden items
  * item[+]
    ...
    * linkId = "patientIdMedicalHistory"
    * type = #string  
...
// table for new diagnoses
  * item[+]
    * extension[questionnaire-itemControl].valueCodeableConcept = http://hl7.org/fhir/questionnaire-item-control#gtable
    * extension[http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-templateExtract].extension[template].valueReference.reference = "#Condition"
