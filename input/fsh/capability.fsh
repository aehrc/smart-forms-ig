Instance: SmartFormsApplicationIntegrationRequirement
...
Usage: #definition
* url = "xxx-endpoint/metadata"
* name = "SmartFormsServerSystemCapabilities"
* description = "Capabilities of the Smart Forms Server instance."
* status = #draft
* experimental = true
* date = "2023-01-31"
* kind = #instance
//? from HAPI - are we locking it down or just adding additional on top?
* imports = "http://hapi.com"
* fhirVersion = #4.0.1
* format[0] = #json
* format[1] = #xml
...
* rest.resource[=].operation[1].name = "assemble"
* rest.resource[=].operation[1].definition = "http://hl7.org/fhir/uv/sdc/OperationDefinition/Questionnaire-assemble"
