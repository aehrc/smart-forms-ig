...
* description = "This CapabilityStatement describes the capabilities of the Smart Forms application. It lists the application's use of resource types used in a launch context, for prepopulation and completion of forms. These capabilities include supported FHIR profiles, RESTful operations, and search parameters."
* status = #draft
* experimental = false
* date = "2023-06-16"
* publisher = "AEHRC CSIRO"
