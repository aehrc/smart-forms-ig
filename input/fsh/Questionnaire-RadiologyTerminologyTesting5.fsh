...
Instance: RadiologyTerminologyPOCTesting5
...
* item[=].item[=].extension[=].valueExpression.language = #text/fhirpath
* item[=].item[=].extension[=].valueExpression.expression = "iif(%procedureFocus.exists(), %terminologies.translate('http://erequestingexample.org.au/ConceptMap/radiology-services-map-1', %procedureFocus, %translateAdditionalParams).parameter.where(exists(name='match' and part.where(exists(name='equivalence' and value='equivalent')))).part.where(name='concept').value, {})"
// Body site codings
* item[=].item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/variable"
...
* item[=].item[=].extension[=].valueExpression[=].language = #text/fhirpath
* item[=].item[=].extension[=].valueExpression[=].expression = "%terminologies.expand('https://smartforms.csiro.au/ig/ValueSet/radiologypoc-bodysite-plainxray-1').expansion.contains"
* item[=].item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/variable"
...
* item[=].item[=].extension[=].valueExpression[=].language = #text/fhirpath
* item[=].item[=].extension[=].valueExpression[=].expression = "%terminologies.expand('https://smartforms.csiro.au/ig/ValueSet/radiologypoc-bodysite-fluoro-1').expansion.contains"
* item[=].item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/variable"
...
* item[=].item[=].item[=].extension[=].valueExpression[+].language = #text/fhirpath
* item[=].item[=].item[=].extension[=].valueExpression[=].expression = "iif(%procedureRequest.count()=1, %procedureRequest)"
/*
