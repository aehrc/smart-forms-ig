...
* item[+] 
  ...
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/AboutTheHealthCheck|0.4.0"
    * linkId = "cd3303a6-e3b6-4732-80e8-54d2bd740beb"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/AboutTheHealthCheck|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Consent
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Consent|0.4.0"
    * linkId = "fab52f87-22a6-4a54-9797-0bb6b0f5d2a2"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Consent|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Patient Details
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/PatientDetails|0.4.0"
    * linkId = "1d10910d-c195-4964-bdc6-98310a44719e"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/PatientDetails|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Current Priorities
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/CurrentPriorities|0.4.0"
    * linkId = "7692f28c-7c0a-48ea-b27d-a8489974377d"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/CurrentPriorities|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Medical History and Current Problems
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/MedicalHistoryCurrentProblems|0.4.0"
    * linkId = "15f83d80-f49a-4852-a20f-18db9b951e53"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/MedicalHistory|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Regular Medications
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/RegularMedications|0.4.0"
    * linkId = "3a7151ef-d63b-4818-8367-03d394383a61"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/RegularMedications|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Allergies Adverse Reactions
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/AllergiesAdverseReactions|0.4.0"
    * linkId = "334853dc-88d4-4cb1-a119-bb0ff6ea0516"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/AllergiesAdverseReactions|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Family History
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/FamilyHistory|0.4.0"
    * linkId = "1ab9b519-85ce-48ee-a408-8f0b9b74d112"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/FamilyHistory|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Social And Emotional Wellbeing
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/SocialAndEmotionalWellbeing|0.4.0"
    * linkId = "228b8d31-21e3-49a6-b802-984135908dca"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/SocialAndEmotionalWellbeing|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Social History Child
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/SocialHistoryChild|0.4.0"
    * linkId = "a43517f9-538e-4a4d-8789-b6c3d44206ba"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/SocialHistoryChild|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Home And Family
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/HomeAndFamily|0.4.0"
    * linkId = "8decf7bf-e24c-4d3d-815c-c53e269f004b"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/HomeAndFamily|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Learning And Development
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/LearningAndDevelopment|0.4.0"
    * linkId = "3f554c37-7d0e-4b14-8f7f-a9ec665cc0a6"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/LearningAndDevelopment|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Learning And Work
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/LearningAndWork|0.4.0"
    * linkId = "362bf381-23e5-4eee-963a-3de73e584da5"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/LearningAndWork|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Mood
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Mood|0.4.0"
    * linkId = "51a545fa-907f-40f0-9304-36bcab5a16b8"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Mood|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Memory And Thinking
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/MemoryAndThinking|0.4.0"
    * linkId = "4217646d-e8e4-4ac5-baa7-fae28937cda7"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/MemoryAndThinking|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Chronic Disease Ageing
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/ChronicDiseaseAgeing|0.4.0"
    * linkId = "070eadcf-9e93-499e-8615-61991ab35b32"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/ChronicDiseaseAgeing|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Screening Programs
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/ScreeningPrograms|0.4.0"
    * linkId = "56d4bc0b-3bf1-4d47-ac34-5a1de0902de1"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/ScreeningPrograms|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Healthy Eating
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/HealthyEating|0.4.0"
    * linkId = "e0962739-c506-41d4-afd7-ab1b90db9cb4"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/HealthyEating|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Physical Activity And Screen Time
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/PhysicalActivityAndScreenTime|0.4.0"
    * linkId = "63cfb279-cd7d-41ed-a54b-0c17b6efe609"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/PhysicalActivityAndScreenTime|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Red Flags Early Identification Guide For Children
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/RedFlagsEarlyIdentificationGuide|0.4.0"
    * linkId = "db70690e-2199-495a-9919-53697efaf913"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/RedFlagsEarlyIdentificationGuide|0.4.0] not available. Unable to display all questions."
    * type = #display    
  // Substance Use
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/SubstanceUse|0.4.0"
    * linkId = "d1f66f56-75fa-4498-9c51-eb98e1644243"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/SubstanceUse|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Gambling
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Gambling|0.4.0"
    * linkId = "ea748251-bf77-4085-b912-e9002dfa02ca"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Gambling|0.4.0] not available. Unable to display all questions."
    * type = #display
  // SexualHealth
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/SexualHealth|0.4.0"
    * linkId = "84bd802b-b3e1-4098-aa2c-2133f0e252f4"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/SexualHealth|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Eye Health
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/EyeHealth|0.4.0"
    * linkId = "56ad8128-0e12-4779-8ff4-47dcff6b29b5"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/EyeHealth|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Ear Health And Hearing
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/EarHealthAndHearing|0.4.0"
    * linkId = "a8161e91-7cff-403f-85e6-982a9bc8fca6"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/EarHealthAndHearing|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Oral And Dental Health
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/OralAndDentalHealth|0.4.0"
    * linkId = "fe05d868-aaed-4921-9d49-4e7746bbe143"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/OralAndDentalHealth|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Skin
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Skin|0.4.0"
    * linkId = "64ec4c1c-0824-4b84-8d3f-40f6e066cb80"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Skin|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Immunisation
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Immunisation|0.4.0"
    * linkId = "595737cd-3a94-442b-8be6-ab461c3181d2"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Immunisation|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Examination
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Examination|0.4.0"
    * linkId = "3263611d-5813-4393-a660-d10166acd728"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Examination|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Absolute CVD Risk Calculation
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/AbsoluteCVDRiskCalculation|0.4.0"
    * linkId = "3a3b0810-e091-48ad-af50-913b0deaf663"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/AbsoluteCVDRiskCalculation|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Investigations
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/Investigations|0.4.0"
    * linkId = "302d9437-25b9-41e3-9d66-138c352d32a8"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/Investigations|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Health Priorities Summary
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/HealthPrioritiesSummary|0.4.0"
    * linkId = "ada45623-5e86-49ea-a00b-be0699364281"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/HealthPrioritiesSummary|0.4.0] not available. Unable to display all questions."
    * type = #display
  // Finalising Health Check
  * item[+] 
    * extension[sdc-questionnaire-subQuestionnaire].valueCanonical = "http://www.health.gov.au/assessments/mbs/715/FinalisingHealthCheck|0.4.0"
    * linkId = "a6395946-872a-4f2e-b697-c74aa1ab9b8d"
    * text = "Sub-questionnaire [http://www.health.gov.au/assessments/mbs/715/FinalisingHealthCheck|0.4.0] not available. Unable to display all questions."
    * type = #display
